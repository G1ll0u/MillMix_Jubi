...
<img width="256" height="256" alt="logo_x2048_1 1" src="https://github.com/user-attachments/assets/88d0609b-a271-4fb3-b1a9-7c833d87b633" />
...
It also adds some values to "M" menu, among others, you can now set villager names distance to 0 and totally hide names.
...
|                               | Make villagers harvest and plant slower                                                  | Implemented |                                                                                                                                                                                                         |
...
| **world generation**          | Smoother Building Placement Near mountains (applies to walls since 1.1.2)                | Implemented | Stops buildings from popping up right on the edge of mountains or uneven ground by making sure the land around them is flat enough. Adjustable config : maxTerrainHeightDiff=8 and maxWallTerrainDiff=8 |
|                               | Ability to disable walls generation in config (since 1.1.2)                              | Implemented | Toggleable config : disableWalls=false                                                                                                                                                                  |
| **villager behaviour**        | Include all MillMix fixes                                                                | Implemented |                                                                                                                                                                                                         |
...
| **command**                   | `/millGetRep` to get reputation for the village (from old MillMix)                       | Implemented |                                                                                                                                                                                                         |
